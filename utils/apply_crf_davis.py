...
# davis
image_dir = '/media/wyx/2T/gck/DAVIS/JPEGImages/480p'
mask_dir = '../outputs/2024-01-16/DAVIS16_val'
save_dir = '../outputs/2024-01-16/DAVIS16_val_crf'

# # fbms
# image_dir = '/media/wyx/2T/gck/FBMS/TestSet/JPEGImages'
# mask_dir = '../outputs/2024-01-17/FBMS_test'
# save_dir = '../outputs/2024-01-17/FBMS_test_crf'
#
# # youtubeobjects
# image_dir = '/media/wyx/2T/gck/YouTubeObjects_for_eval/JPEGImages'
# mask_dir = '../outputs/2024-01-17/YouTubeObjects'
# save_dir = '../outputs/2024-01-17/YouTubeObjects_crf'
