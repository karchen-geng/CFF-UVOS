...
mask_data_root = "/mnt/31f271cb-1eab-41e4-aa15-7caf8b6e7528/gck/Second/FBMS/TestSet/Annotations"
...
if __name__ == "__main__":
    eval_method_from_data(
        method_pre_path="outputs/CFF-Net-test/FBMS_test",
        ignore_tail=True,
        ignore_head=True,
        save_path="results/CFF-Net-test/FBMS_test.pkl",
    )
